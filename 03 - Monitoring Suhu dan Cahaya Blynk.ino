...
const int tempSensorPin = 27;
const int ledLuxPin = 26;
const int ledCelPin = 25;

//Koneksi ke blynk dan wifi
char auth[] = "yw3gAohI7HQS8lidIMz8SWfuNN2hnFDQ";
char ssid[] = "HUAWEI-j9XQ";
char password[] = "3CnChVEt";
...
void setup() {
  ...
  Blynk.begin(auth, ssid, password, IPAddress(192, 168, 100, 8), 8080);
  dht11.begin();
}
